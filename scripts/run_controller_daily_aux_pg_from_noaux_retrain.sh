...
RUN_NAME="${RUN_NAME:-lookback60_hold30_daily_pg_balanced_sh90_5ep}"
GPU_ID="${GPU_ID:-0}"
...
CONTROLLER_SUP_PRETRAIN_EPOCHS="${CONTROLLER_SUP_PRETRAIN_EPOCHS:-0}"
CONTROLLER_SUP_PRETRAIN_ROLLOUT_LEN="${CONTROLLER_SUP_PRETRAIN_ROLLOUT_LEN:-240}"
CONTROLLER_AUX_PRETRAIN_OFFPOLICY="${CONTROLLER_AUX_PRETRAIN_OFFPOLICY:-0}"
CONTROLLER_AUX_REPLAY_EPOCHS="${CONTROLLER_AUX_REPLAY_EPOCHS:-1}"
CONTROLLER_ROLLOUT_LEN="${CONTROLLER_ROLLOUT_LEN:-600}"
CONTROLLER_WINDOWS_PER_EPOCH="${CONTROLLER_WINDOWS_PER_EPOCH:-30}"
CONTROLLER_FIXED_POOL_LIMIT="${CONTROLLER_FIXED_POOL_LIMIT:-0}"
...
CONTROLLER_EPISODE_BATCH_SIZE="${CONTROLLER_EPISODE_BATCH_SIZE:-6}"
CONTROLLER_EPISODE_PARALLEL_WORKERS="${CONTROLLER_EPISODE_PARALLEL_WORKERS:-6}"
...
CONTROLLER_INIT_EXIT_BIAS="${CONTROLLER_INIT_EXIT_BIAS:--2.5}"
...
CONTROLLER_MAX_SWITCH_PENALTY_COEF="${CONTROLLER_MAX_SWITCH_PENALTY_COEF:-0.0001}"
...
CONTROLLER_AUX_SWITCH_ADV_COEF="${CONTROLLER_AUX_SWITCH_ADV_COEF:-0.0}"
...
echo "Controller eval: eval_threshold=$CONTROLLER_EVAL_SWITCH_THRESHOLD"
echo "Constraints: no min-hold, forced max_hold=$MAX_HOLD switch, max switches=$CONTROLLER_MAX_SWITCHES, max_switch_penalty=$CONTROLLER_MAX_SWITCH_PENALTY_COEF, expected_switch_penalty=$CONTROLLER_EXPECTED_SWITCH_PENALTY_COEF, fixed_pool_limit=$CONTROLLER_FIXED_POOL_LIMIT, skip_fixed_scenarios=$TEST_SKIP_FIXED_SCENARIOS, test_max_days=$TEST_MAX_DAYS"
