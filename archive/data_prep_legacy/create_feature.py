...
if __name__ == '__main__':
    ...
    main(os.path.join( "CMIN-Dataset-main", "CMIN-Dataset-main", "CMIN-US","price","raw"),
         os.path.join( "CMIN-Dataset-main", "CMIN-Dataset-main", "CMIN-US","price","features"))
    main(os.path.join( "CMIN-Dataset-main", "CMIN-Dataset-main", "CMIN-CN", "price", "raw"),
         os.path.join(  "CMIN-Dataset-main", "CMIN-Dataset-main", "CMIN-CN", "price", "features"))