...
The table isolates the mechanical effect of charging alternative costs to the same environment-recorded path. The reference column exactly reproduces the original evaluation. It does not represent inference or training under the alternative cost rates.
