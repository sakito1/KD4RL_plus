...
class InnerAC(nn.Module):
    ...
    def __init__(self, in_features, hidden_dim, dropout=0.2):
        super().__init__()
        self.hidden_dim = hidden_dim
...
class MonitorAC(nn.Module):
    ...
    The preferred input is asset_state=[B,N,T,F] from outer_state. The
...
class FullModel(nn.Module):
    def __init__(self,
        ...
        # Inner: shared encoder and actor/critic heads.
        inner_args = {
