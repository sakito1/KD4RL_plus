...
RUN_NAME="${RUN_NAME:-sh_full_42135_risk10_adv0_or_adv10_seed${SEED}}"
...
echo "SH full CMTFlow training and test"
...
export MPLCONFIGDIR="${MPLCONFIGDIR:-/tmp/mpl-sh-risk10-adv0-${SEED}}"
